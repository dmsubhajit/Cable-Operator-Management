...
Partial Class bill
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label11.Text = Session("paymode")
        Label4.Text = Session("payidcash")
        'Session("payidonline") = DropDownList3.SelectedValue

        Try
            con.Open()
            cmd1 = New SqlCommand("select * from cashpayment where payid='" + Label4.Text + "'", con)
            ...
            If dr1.Read Then
                ...
                Label7.Text = dr1(3).ToString
                Label5.Text = dr1(6).ToString
                Label6.Text = dr1(7).ToString
                Label8.Text = dr1(9).ToString
